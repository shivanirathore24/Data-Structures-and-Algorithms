...
public class TreeContainsX {
    ...
    public static void main(String[] args) {
        ...
        printTree(root);
        System.out.println(checkIfContainsX(root, 3)); // true
    }
}
...
Explanation:
- Check current node data with x
- Recursively search in all child subtrees
- Return true if x is found anywhere
*/
